...
// stockée directement dans l'objet utilisateur (localStorage, via
// PO_Auth.updateProfile). Il n'y a pas de vrai service de stockage de
// fichiers (ex. S3 / Supabase Storage) : toute la logique — lecture du
// fichier, recadrage, redimensionnement, compression — se fait dans le
// navigateur avec l'API Canvas.
//
// Point de branchement futur (backend réel) :
//   - Remplacer le stockage base64 par un upload vers Supabase Storage
//     (ou équivalent), et ne garder dans le profil utilisateur qu'une URL.
//   - Le recadrage/redimensionnement client peut rester identique : on
//     enverrait alors le blob recadré au lieu de la dataURL.
// =========================================================
