...
//
// Intégration Stripe RÉELLE (mode TEST) via Stripe Elements.
...
const PO_StripePayment = (() => {
  ...
  const API_BASE_URL = 'https://ntabou-aka-we-api.onrender.com';
  ...
  return { init, mountCardElement, pay, isReady, getLastError };
})();
