...
3. Développeurs → Webhooks → crée un NOUVEL endpoint pour la production (les
   webhooks test et Live sont séparés) → URL : `https://ntabou-aka-we-api.onrender.com/api/stripe-webhook`
...
5. Vérifie sur `https://ntabou-aka-we-api.onrender.com/api/stripe-config` que
...
2. URL : `https://ntabou-aka-we-api.onrender.com/api/stripe-webhook`
