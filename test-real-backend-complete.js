...
async function run() {
  ...
  const dupRegister = await request('POST', '/api/auth/register', {
    firstName: 'Alice2', lastName: 'X', email: 'alice@example.com', age: 25, password: 'Autre1234', privacyConsent: true
  });
  ...
  const bobRegister = await request('POST', '/api/auth/register', {
    firstName: 'Bob', lastName: 'Gagnon', email: 'bob@example.com', age: 40, password: 'MotDePasse2', privacyConsent: true
  });
  ...
  const carolRegister = await request('POST', '/api/auth/register', {
    firstName: 'Carol', lastName: 'Simard', email: 'carol@example.com', age: 35, password: 'MotDePasse3', privacyConsent: true
  });
