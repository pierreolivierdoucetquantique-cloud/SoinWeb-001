...
async function run() {
  ...
  await smokeTest('inscription.html', ['script.js', 'auth.js', 'notifications-store.js']);
  await smokeTest('connexion.html', ['script.js', 'auth.js']);
  await smokeTest('mot-de-passe-oublie.html', ['script.js', 'auth.js', 'notifications-store.js', 'email-service.js']);
  await smokeTest('reinitialiser-mot-de-passe.html', ['script.js', 'auth.js']);
  await smokeTest('contact.html', ['script.js']);
  await smokeTest('histoire.html', ['content-store.js', 'pricing.js', 'auth.js', 'script.js']);
  await smokeTest('conditions.html', ['script.js']);
  await smokeTest('confidentialite.html', ['script.js']);
  await smokeTest('soin-interactif.html', ['auth.js', 'content-store.js', 'pricing.js', 'notifications-store.js', 'care-session-store.js', 'care-pdf.js', 'care-session.js']);
