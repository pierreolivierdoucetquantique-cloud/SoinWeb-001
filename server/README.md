...
| `STRIPE_WEBHOOK_SECRET` | Voir `server-stripe/README-STRIPE.md` pour la procédure complète |
...
```
https://ntabou-aka-we-api.onrender.com
```
...
de `ntabou-aka-we-api.onrender.com`, dis-le-moi et je mets à jour ces deux
fichiers moi-même.
...
## 8. Stripe — configuration complète

Voir `server-stripe/README-STRIPE.md` pour la procédure détaillée (webhook,
cartes de test, passage en mode Live).
