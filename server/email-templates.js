...
const TEMPLATES = {
  ...
  care_completed: (v) => ({
    subject: 'Votre séance Soin Direct est terminée',
    html: wrap('Séance terminée', `
      <p>Bonjour ${esc(v.first_name)},</p>
      <p>Votre séance de Soin Direct est maintenant terminée. Merci de votre confiance.</p>`)
  }),
  password_reset: (v) => ({
